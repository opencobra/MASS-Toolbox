...
DimensionCompatibleUnitQ[Unit[_, un_]..]:=True;
...
DimensionCompatibleUnitQ[{a__Unit}]:=DimensionCompatibleUnitQ[a];
DimensionCompatibleUnitQ[a___]/;FreeQ[{a}, Unit, Infinity]:=True; (*When no units are present*)
DimensionCompatibleUnitQ[a___]:=False;(*Mix of units and non units*)
...
Convert[expr:{__Unit}]:=If[DimensionCompatibleUnitQ[expr],Convert[expr,Mean[expr]],expr];
...
ConvertTemperature[Unit[a_,un:("Celsius"|"Centigrade")],b_]/;DimensionCompatibleUnitQ[Unit[a,un],b]:=ConvertTemperature[Unit[a+27315/100,"Kelvin"],b]
ConvertTemperature[b_,Unit[a_,un:("Celsius"|"Centigrade")]]/;DimensionCompatibleUnitQ[Unit[a,un],b]:=ConvertTemperature[b,Unit[a,"Kelvin"]]/.Unit[f_,"Kelvin"]:>Unit[f-27315/100,un]
ConvertTemperature[Unit[a_,"Fahrenheit"],b_]/;DimensionCompatibleUnitQ[Unit[a,"Fahrenheit"],b]:=ConvertTemperature[Unit[a+45967/100,"Rankine"],b]
ConvertTemperature[b_,Unit[a_,"Fahrenheit"]]/;DimensionCompatibleUnitQ[Unit[a,"Fahrenheit"],b]:=ConvertTemperature[b,Unit[a,"Rankine"]]/.Unit[f_,"Rankine"]:>Unit[f-45967/100,"Fahrenheit"]
...
Unit/:Plus[a_Unit,b__Unit]/;DimensionCompatibleUnitQ[a,b]:=Unit[Total[First/@#],#[[1,2]]]&[Convert[{a,b}]];
The work that is done here in Plus should really be done in Convert
*)

Unit/:Plus[a_Unit,b__Unit]/;DimensionCompatibleUnitQ[a,b]:=
...
Unit/:Unequal[a__Unit]:=
    If[Quiet[DimensionCompatibleUnitQ[a]],Apply[Unequal,Map[First,Convert[{a}]]],
      True];
...
Unit/:Min[a_Unit,b__Unit]/;DimensionCompatibleUnitQ[{a,b}]:=First[Sort[{a,b}]];
Unit/:Max[a_Unit,b__Unit]/;DimensionCompatibleUnitQ[{a,b}]:=Last[Sort[{a,b}]];
Unprotect[Min,Max];
Min[{a_Unit,b__Unit}]/;DimensionCompatibleUnitQ[{a,b}]:=First[Sort[{a,b}]];
Max[{a_Unit,b__Unit}]/;DimensionCompatibleUnitQ[{a,b}]:=Last[Sort[{a,b}]];
Protect[Min,Max];
...
Function[{fn}, Unit/:fn[a_Unit,{b_Unit,c_Unit}]/;DimensionCompatibleUnitQ[a,b,c]:=Block[{common=Convert[{a,b,c}]},
...
Function[{fn}, Unit/:fn[a_Unit,{b_Unit,c_Unit},{d_Unit,e_Unit}]/;DimensionCompatibleUnitQ[a,b,c,d,e]:=Block[{common=Convert[{a,b,c,d,e}]},
...
(Unit/:#[a_Unit,b_Unit]/;DimensionCompatibleUnitQ[a,b]:=Block[
...
(Unit/:#[a_Unit,b_Unit,c_Unit]/;DimensionCompatibleUnitQ[a,b,c]:=Block[
...
(Unit/:#[a__Unit]/;Not[Quiet[DimensionCompatibleUnitQ[a]]]:=False;
...
(Unit/:#[x__Unit]/;DimensionCompatibleUnitQ[x]:=Block[{uns=Convert[{x}]},
											Unit[uns[[1,2]]] Apply[#,First/@uns]])&/@{
												NormalDistribution,PoissonDistribution};
(Unprotect[#];
#[{x__Unit}]/;DimensionCompatibleUnitQ[x]:=Block[{uns=Convert[{x}]},
											Unit[uns[[1,2]]] Apply[#,First/@uns]];
...
RandomReal[{x_Unit,y_Unit},args___]/;DimensionCompatibleUnitQ[x,y]:=
...
RandomInteger[{x_Unit,y_Unit},args___]/;DimensionCompatibleUnitQ[x,y]:=
...
Unprotect[Interval];
Interval[pat:{__Unit}..]/;DimensionCompatibleUnitQ[Flatten[{pat}]]:=Block[{un},
...
Table[expr_,{var_Symbol,Unit[x_,un1_],Unit[y_,un2_]}]/;DimensionCompatibleUnitQ[Unit[x,un1],Unit[y,un2]]:=
...
Table[expr_,{var_Symbol,Unit[x_,un1_],Unit[y_,un2_],Unit[z_,un3_]}]/;DimensionCompatibleUnitQ[Unit[x,un1],Unit[y,un2],Unit[z,un3]]:=
...
Integrate[expr_, {var_, lo_Unit, hi_Unit},opts:OptionsPattern[]] /; 
  DimensionCompatibleUnitQ[lo, hi] := Block[{lo2, hi2},
...
(Unit/:#[ang_Unit]/;DimensionCompatibleUnitQ[ang,Unit[1,"Radian"]]:=#[FundamentalUnits[ang/Unit[1,"Radian"]]])&/@
...
Function[{plottype},
	Unprotect[plottype];
	plottype[data:{__Unit},opts:OptionsPattern[]]/;DimensionCompatibleUnitQ[data]:=
			Function[{arg},plottype[First/@arg,opts,AxesLabel->Unit[1,arg[[1,2]]]]][Convert[data]];
			
(*Broken
	plottype[data:Tooltip[{__Unit}],opts:OptionsPattern[]]/;DimensionCompatibleUnitQ[data]:=
			Function[{arg},
...
Unprotect[PieChart];			
  PieChart[data : {__Unit}, opts : OptionsPattern[]] /; DimensionCompatibleUnitQ[data] :=  Function[{arg}, PieChart[First /@ arg, opts]][Convert[data]]; 
PieChart[data : {{__Unit} ..}, opts : OptionsPattern[]] /; DimensionCompatibleUnitQ[data] :=  Function[{arg}, PieChart[arg,opts]][  Map[First, Convert /@ data, {2}]];
 Protect[PieChart];
...
(Unprotect[#];
#[pat:{{_,_}..},opts:OptionsPattern[]]/;If[FreeQ[pat,Unit],False,Apply[And,Map[DimensionCompatibleUnitQ,Transpose[pat]]]]:=
...
(Unprotect[#];
#[pat:{{_,_,_}..},opts:OptionsPattern[]]/;If[FreeQ[pat,Unit],False,Apply[And,Map[DimensionCompatibleUnitQ,Transpose[pat]]]]:=
	Block[{data=ColumnConvert[pat]},
		#[data[[1]],opts,
...
DateListPlot[data:{__Unit},datespec_,opts:OptionsPattern[]]/;DimensionCompatibleUnitQ[data]:=
Function[{arg},DateListPlot[First/@arg,datespec,opts,FrameLabel->{Automatic,Unit[1,arg[[1,2]]]}]][Convert[data]];


DateListPlot[pat : {{_, _Unit} ..},opts:OptionsPattern[]]/;DimensionCompatibleUnitQ[pat[[All,2]]] := 
...
(Unprotect[#];
#[pat : {{_Unit,_Unit,_Unit,__Unit} ..},opts:OptionsPattern[]]/;(DimensionCompatibleUnitQ[Flatten[pat]]&&TensorRank[pat]===2):= 
...
RemoveUnitsFromRange[lo_, hi_] := Block[{un, nlo, nhi},
   If[Not[FreeQ[lo, _Unit]] && DimensionCompatibleUnitQ[lo, hi],
    (*Then*)
...
(Unprotect[#];
    #[expr_, {var_Symbol, lo_, hi_}, 
       opts : OptionsPattern[]] /; ((Not[FreeQ[lo, _Unit]] && DimensionCompatibleUnitQ[lo, hi]) || Not[FreeQ[Unevaluated[expr] /. var -> lo, _Unit]]) && (lo != hi) :=
...
(Unprotect[#];
    #[expr_, {var_Symbol, lo_, hi_}, {var2_Symbol, lo2_, hi2_}, 
       opts : OptionsPattern[]] /; ((Not[FreeQ[lo, _Unit]] &&  DimensionCompatibleUnitQ[lo, hi])|| (Not[FreeQ[lo2, _Unit]] && DimensionCompatibleUnitQ[lo2, hi2])
...
(Unprotect[#];
    ...
    (((Not[FreeQ[lo, _Unit]] && DimensionCompatibleUnitQ[lo, hi])|| (Not[FreeQ[lo2, _Unit]] &&  DimensionCompatibleUnitQ[lo2, hi2])
          || (Not[FreeQ[lo3, _Unit]] &&  DimensionCompatibleUnitQ[lo3, hi3]) || Not[FreeQ[ expr /. {var -> lo, var2 -> lo2,  var3 -> lo3}, _Unit]]) 
...
CompatibleUnitsFromSet[set_, un_Unit] := CompatibleUnitsFromSet[set, un]= Quiet[Sort@Select[UnitSet[set], DimensionCompatibleUnitQ[#, un] &]];
...
UnitToDimension[un_Unit]:=Quiet[Select[$DimensionRepresentatives,DimensionCompatibleUnitQ[#[[2]],un]&][[1,1]]];
