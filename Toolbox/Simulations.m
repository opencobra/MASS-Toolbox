	...
	Check[
			...
			solution=(*#[[1]]->(#[[2]] (#[[1]][[0]]/.Dispatch[units]))&/@*)
				Check[
					...
					Message[simulate::NDSolveProblem];Abort[];,{NDSolve::ndode,NDSolve::idelay,NDSolve::icfail,NDSolve::nderr,NDSolve::underdet,NDSolve::nlnum,NDSolve::overdet,NDSolve::ndinnt}][[1]],
...
findSteadyState[model_MASSmodel,opts:OptionsPattern[]]:=Module[{eq,var,rosetta,param,ic,sol,eigenvalues,units,fluxSol,error,errors,ode},
	...
	ic=updateRules[model["InitialConditions"],adjustUnits[OptionValue["InitialConditions"]]];
