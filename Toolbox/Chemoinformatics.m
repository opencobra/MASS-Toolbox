...
Check[
svgInput=Switch[cmpd,_InChI,Import["!"<>$SystemCommandPrefix<>" echo '"<>getID@cmpd<>"' | obabel -i inchi -o svg","XML"],_SMILES,Import["!"<>$SystemCommandPrefix<>" echo '"<>getID@cmpd<>"' | obabel -i smiles -o svg","XML"]],
...
(*ImportString[molconvert[cmpd,"pdf",""],"PDF"][[1]]*)
JavaBlock[
...
drawCompound[cmpd:(_InChI|_SMILES),opts:OptionsPattern[]]:=Switch[OptionValue["Method"],
