...
def:mat2model[___]:=(Message[Toolbox::badargs,mat2model,Defer@def];Abort[])
Protect[mat2model];
...
Unprotect[getHasOnlySubstanceUnits];
...
Protect[getHasOnlySubstanceUnits];


Unprotect[getBoundaryConditions];
...
Unprotect[xmlReaction2reaction];
...
def:xmlReaction2reaction[___]:=(Message[Toolbox::badargs,xmlReaction2reaction,Defer@def];Abort[])
Protect[xmlReaction2reaction];


Unprotect[sbml2reactions];
...
def:sbml2reactions[___]:=(Message[Toolbox::badargs,sbml2reactions,Defer@def];Abort[])
Protect[sbml2reactions];


Unprotect[sbml2modelSimple];
...
def:sbml2modelSimple[___]:=(Message[Toolbox::badargs,sbml2modelSimple,Defer@def];Abort[])
Protect[sbml2modelSimple];


Unprotect[sbml2model];
...
def:sbml2model[___]:=(Message[Toolbox::badargs,sbml2model,Defer@def];Abort[])
Protect[sbml2model];
...
def:biomodel2model[___]:=(Message[Toolbox::badargs,biomodel2model,Defer@def];Abort[])
